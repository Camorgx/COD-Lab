...
module EX_MEM(
    ...
    always @(posedge clk or posedge rst) begin
        if (rst) begin 
            ...
            pc_add_4_mem <= pc_add_4_ex; pc_add_imm_mem <= pc_add_imm_reg;
        end
    end
endmodule
