...
#
# Generated by export_simulation on Tue May 24 12:43:50 +0800 2022
#
################################################################################
...
'-reset_run' switch to the './dist_mem_inst.sh' script.

./dist_mem_inst.sh -reset_run
...
./dist_mem_inst.sh -noclean_files

For more information on the script, please type './dist_mem_inst.sh -help'.
