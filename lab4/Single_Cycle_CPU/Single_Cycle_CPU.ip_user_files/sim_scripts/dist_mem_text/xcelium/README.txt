...
#
# Generated by export_simulation on Fri Apr 08 09:20:00 +0800 2022
#
################################################################################
...
'-reset_run' switch to the './dist_mem_text.sh' script.

./dist_mem_text.sh -reset_run
...
./dist_mem_text.sh -noclean_files

For more information on the script, please type './dist_mem_text.sh -help'.
