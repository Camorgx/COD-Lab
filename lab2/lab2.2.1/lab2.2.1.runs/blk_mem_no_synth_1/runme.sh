...
HD_PWD='C:/Users/18213/Sources/Vivado_Projects/Principle_Of_Computer_Composition/lab2/lab2.2.1/lab2.2.1.runs/blk_mem_no_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log blk_mem_no.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source blk_mem_no.tcl
